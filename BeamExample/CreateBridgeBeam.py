...
print('Load CreateBridgeBeam.py')
...
def move_handle(build_ele, handle_prop, input_pnt, doc):
    ...
    if handle_prop.handle_id == "BeamHeight":
        build_ele.RibHeight.value = build_ele.BeamHeight.value - build_ele.TopShHeight.value - \
                                    build_ele.BotShLowHeight.value - build_ele.BotShUpHeight.value
...
def modify_element_property(build_ele, name, value):
    ...
    if name == "BeamHeight":
        change = value - build_ele.TopShHeight.value - build_ele.RibHeight.value - \
                 build_ele.BotShUpHeight.value - build_ele.BotShLowHeight.value
        ...
        build_ele.BeamHeight.value = value + build_ele.RibHeight.value + \
                                     build_ele.BotShUpHeight.value + build_ele.BotShLowHeight.value
    elif name == "RibHeight":
        build_ele.BeamHeight.value = value + build_ele.TopShHeight.value + \
                                     build_ele.BotShUpHeight.value + build_ele.BotShLowHeight.value
    elif name == "BotShUpHeight":
        build_ele.BeamHeight.value = value + build_ele.TopShHeight.value + \
                                     build_ele.RibHeight.value + build_ele.BotShLowHeight.value
        ...
        build_ele.BeamHeight.value = value + build_ele.TopShHeight.value + \
                                     build_ele.RibHeight.value + build_ele.BotShUpHeight.value
    ...
    def create_beam(self, build_ele):
        ...
        sling_holes = AllplanGeo.BRep3D.CreateCylinder(
            AllplanGeo.AxisPlacement3D(
                AllplanGeo.Point3D(0, build_ele.HoleDepth.value, build_ele.HoleHeight.value),
